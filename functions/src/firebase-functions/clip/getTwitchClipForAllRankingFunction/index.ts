...
export const getTwitchClipForAllRankingFunction = functions
    ...
    .timeZone(`Asia/Tokyo`)
    .onRun(async () => {
        const getTwitchClipForAllRankingFunctionLogic = await GetTwitchClipForAllRankingFunctionLogic.init();

        const streamers = await getTwitchClipForAllRankingFunctionLogic
            .getStreamers();
        await getTwitchClipForAllRankingFunctionLogic
